...
双平台适配
  ├─ Netlify：Next.js Functions + Blobs
  └─ OpenAI Sites：Cloudflare Worker + D1 / R2
```

主要技术：TypeScript、React 19、Next 16、vinext、Netlify Blobs、Cloudflare D1 / R2、Drizzle ORM、DeepSeek API。
